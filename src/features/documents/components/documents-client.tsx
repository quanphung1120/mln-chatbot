...
import { deleteDocumentAction, type DocumentRow } from "@/features/documents/actions";
    ...
    >
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          or click to browse &mdash; .txt, .md &amp; .pdf, up to 10 MB
        </p>
      </div>
      <input
        ref={inputRef}
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg rounded-3xl gap-6">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a plain-text, Markdown, or PDF file. It will be chunked and
            indexed for use as reference material in the chatbot.
          </DialogDescription>
        </DialogHeader>
